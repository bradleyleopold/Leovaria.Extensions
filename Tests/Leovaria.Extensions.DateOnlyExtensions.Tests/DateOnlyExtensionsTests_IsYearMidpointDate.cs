    ...
    public sealed class DateOnlyExtensionsTests_IsYearMidpointDate
    {
        ...
        public static TheoryData<DateOnly, bool> GetsExpectedResult_TestData()
        {
            return new TheoryData<DateOnly, bool>
            {
                ...
                { new DateOnly(2024, 07, 02), true },
                { new DateOnly(2025, 07, 02), false },
            };
        }
    }
}
