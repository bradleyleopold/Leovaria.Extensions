...
namespace Leovaria.Extensions.DateOnlyExtensions
{
    ...
    public static class DateOnlyExtensions
    {
        ...
        {
            return untilDate.DayNumber - value.DayNumber;
        }
        ...
        {
            return DateOnly.FromDateTime(untilDate).DayNumber - value.DayNumber;
        }
        ...
        {
            return new DateOnly(year, month, day).DayNumber - value.DayNumber;
        }
        ...
        {
            return value.DayNumber - sinceDate.DayNumber;
        }
        ...
        {
            return value.DayNumber - DateOnly.FromDateTime(sinceDate).DayNumber;
        }
        ...
        {
            return value.DayNumber - new DateOnly(year, month, day).DayNumber;
        }
    }
}
